  ...
  client.on("interactionCreate", async (interaction) => {
    ...
    guild.channels.create(channelname.substr(0, 31), optionsData).then(async ch => {
      ...
      var ticketembed = new MessageEmbed()
        .setColor(0x2b2d31).setThumbnail(es.thumb ? es.footericon : null)
      ...
      if(ticket.claim.enabled){
        var claimEmbed = new MessageEmbed()
          ...
          .setAuthor(`A Staff Member will claim the Ticket soon!`, "https://cdn.discordapp.com/emojis/833101350623117342.gif?size=44", "https://discord.gg/4TeeFAdnuD")
