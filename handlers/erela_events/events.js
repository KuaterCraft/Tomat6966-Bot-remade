      ...
      try {
        ...
        if(channel && channel.permissionsFor(channel.guild.me).has(Permissions.FLAGS.SEND_MESSAGES)){
          ...
          collector.on('collect', async i => {
              ...
              if (!player)
                return i?.reply({content: "<:fcross:1064768376829919264> Nothing Playing yet", ephemeral: true})
...
/**
* @INFO
* Bot Coded by KuaterCraft#0062 | https://github?.com/KuaterCraft#0062/discord-js-lavalink-Music-Bot-erela-js
* @INFO
/**/
