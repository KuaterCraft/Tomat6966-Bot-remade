        ...
        if(set.includes(message.channel.id) || set.includes(message.channel.parentId)){
            try{
                ...
                if(targetMessage.embeds[0]){
                    ...
                    embed.setColor(0x2b2d31).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
                    embed.setTimestamp()
