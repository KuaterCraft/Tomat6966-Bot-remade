        ...
        if (args[0].toLowerCase() === "start") {
            try{
                ...
                let options = {
                    ...
                    botsCanWin: false,
                    embedColor: require("discord.js").Util.resolveColor(0x2b2d31) ? require("discord.js").Util.resolveColor(0x2b2d31) : 3932049,
            ...
            client.giveawaysManager.reroll(giveaway.messageId, { winnerCount: !isNaN(args[1]) ? Number(args[1]) : 1})
                ...
                .catch((e) => {
                    if (e.startsWith(`Giveaway with message Id ${giveaway.messageId} is not ended.`)) {
                        ...
                        console.error(e);
                        message.reply({content : '<:fcross:1064768376829919264> **An error occured...**```' + String(e.message).substr(0, 1900) + "```"});
                    }
                });
        ...
        if(client.settings.get(message.guild.id, `adminlog`) != "no"){
            try{
              ...
              channel.send({embeds :[new MessageEmbed()
                .setColor(0x2b2d31).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon)
