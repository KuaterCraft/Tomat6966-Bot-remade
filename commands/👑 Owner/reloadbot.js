...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      return message.reply({content : `**<:fcross:1064768376829919264> THIS COMMAND IS DISABLED, go to discord.gg/Ferren and <#840332764603351101> to get it restarted!**\n\n\n> **Path:**
\`\`\`
${process.cwd()}
\`\`\`
> **Server:**
...
\`\`\``
      ...
      let tempmsg = await message.channel.send({embeds :[new MessageEmbed()
        .setColor(0x2b2d31).setFooter(client.getFooter(es))
        .setAuthor(`Reloading ...`, `https://images-ext-1.discordapp.net/external/ANU162U1fDdmQhim_BcbQ3lf4dLaIQl7p0HcqzD5wJA/https/cdn.discordapp.com/emojis/756773010123522058.gif`,  `https://discord.gg/4TeeFAdnuD`)
      ...
      await tempmsg.edit({embeds: [new MessageEmbed()
        .setColor(0x2b2d31).setFooter(client.getFooter(es))
        .setAuthor(`Successfully Reloaded:`, `https://cdn.discordapp.com/emojis/833101995723194437.gif?v=1`, `https://discord.gg/4TeeFAdnuD`)
