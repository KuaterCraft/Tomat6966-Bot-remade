    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(0x2b2d31)
          .setAuthor('Change Status', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/au-kddi/190/purple-heart_1f49c.png', 'https://discord.gg/4TeeFAdnuD')
          ...
          case "Status 1. Text":
            {
              var tempmsg = await message.reply({embeds: [new MessageEmbed()
                ...
                .setColor(0x2b2d31)
                .setDescription(`Example: \`${prefix}help | ${client.user.username.split(" ")[0]} | by: ferren.dcbot.ml\`
