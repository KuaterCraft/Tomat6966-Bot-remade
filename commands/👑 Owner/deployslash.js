    ...
    if (message.author.id != "844535327892701205")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only KuaterCraft#0062 is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.gg/4TeeFAdnuD), open a Ticket and ask for it!`)
        ]
      });
    try {
