...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel('Support Server').setURL("https://discord.com/gg/Ferren")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter('Ferren', 'https://imgur.com/jPItIw0.gif')
