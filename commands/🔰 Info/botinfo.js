...
module.exports = {
    ...
    try{
      let tempmsg = await message.reply({embeds: [new Discord.MessageEmbed().setColor(0x2b2d31)
      .setAuthor(client.la[ls].cmds.info.botinfo.loading, "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/4TeeFAdnuD")]})
