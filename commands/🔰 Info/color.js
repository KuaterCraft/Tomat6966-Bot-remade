  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<:allright:1065137930391257181> **Name**', "```"+json.name+"```", true)
        .addField("<:allright:1065137930391257181> **Hex**",  "```"+json.hex+"```", true)
        .addField("<:allright:1065137930391257181> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<:allright:1065137930391257181> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
