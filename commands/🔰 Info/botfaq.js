...
module.exports = {
    ...
    let es = client.settings.get(message.guild.id, "embed");let ls = client.settings.get(message.guild.id, "language")
		...
		try{
      let Ferrendc = client.guilds.cache.get("773668217163218944")
      let Ferrenmembers = await Ferrendc.members.fetch().catch(() => {});
      let partnercount = Ferrenmembers.filter(m => m.roles.cache.has("823150244509515807"))
