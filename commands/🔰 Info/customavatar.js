      ...
      if (customavatar) {
        let embed = new Discord.MessageEmbed()
          .setAuthor(handlemsg(client.la[ls].cmds.info.avatar.author, {
            usertag: user.tag
          }), customavatar, "https://discord.gg/4TeeFAdnuD")
          ...
          .addField("<:allright:1065137930391257181> PNG", `[\`LINK\`](${customavatar})`, true)
          .addField("<:allright:1065137930391257181> JPEG", `[\`LINK\`](${customavatar.replace("png", "jpg").replace("gif", "jpg")})`, true)
          .addField("<:allright:1065137930391257181> WEBP", `[\`LINK\`](${customavatar.replace("png", "webp").replace("gif", "webp")})`, true)
          .setURL(customavatar)
        ...
        let embed = new MessageEmbed()
          ...
          .setColor(0x2b2d31).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
          .addField("<:allright:1065137930391257181> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
          .addField("<:allright:1065137930391257181> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
          .addField("<:allright:1065137930391257181> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
...
/*
 * @INFO
 * Bot Coded by KuaterCraft#0062 | https://discord.gg/4TeeFAdnuD
 * @INFO
*/
