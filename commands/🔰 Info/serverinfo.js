...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      embed.addField("**<:allright:1065137930391257181> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:fcross:1064768376829919264> \`No Channel\`"}`, true)
      embed.addField("**<:allright:1065137930391257181> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:fcross:1064768376829919264> \`No Channel\`"}`, true)
      embed.addField("**<:allright:1065137930391257181> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:fcross:1064768376829919264> \`No Channel\`"}`, true)

      embed.addField("**<:allright:1065137930391257181> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<:allright:1065137930391257181> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<:allright:1065137930391257181> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      if(boosts >= 14){
          embed.addField(`**<:allright:1065137930391257181> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:fcross:1064768376829919264> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<:allright:1065137930391257181> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<:allright:1065137930391257181> SERVER DISCOVERY SPLASH:**`)
