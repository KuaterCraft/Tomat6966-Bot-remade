    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(0x2b2d31)
          .setAuthor('Auto Delete Setup', 'https://cdn.discordapp.com/emojis/834052497492410388.gif?size=96', 'https://discord.gg/4TeeFAdnuD')
              ...
              .then(collected => {
                ...
                if (channel) {
                  try {
                    ...
                    if(!time || isNaN(time))
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:fcross:1064768376829919264> Invalid Input | Time wrong`)
                    ...
                    if(time > 60*60 || time < 3)
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:fcross:1064768376829919264> Time out of Range!`)
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`<:fyes:1064768675338530857> I will now delete Messages after \`${time} Seconds\` in **${channel.name}**`)
                      .setColor(0x2b2d31)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
              ...
              .then(collected => {
                ...
                if (channel) {
                  try {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`<:fyes:1064768675338530857> Successfully removed **${channel.name}** out of the Setup!`)
                      .setColor(0x2b2d31)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
