...
module.exports = {
    ...
    try{
      ...
      async function first_layer(){
        ...
        .setColor(0x2b2d31)
        .setAuthor('Join-to-Create Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/joypixels/291/studio-microphone_1f399-fe0f.png', 'https://discord.gg/4TeeFAdnuD')
      ...
      async function second_layer(SetupNumber, menuoptiondata)
      {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
        .setColor(0x2b2d31)
        .setAuthor(SetupNumber + " Join-to-Create Setup", 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/joypixels/291/studio-microphone_1f399-fe0f.png', 'https://discord.gg/4TeeFAdnuD')
