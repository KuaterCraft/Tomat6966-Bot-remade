...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    //only allow the Server owner, (&KuaterCraft#0062) to execute this Command, (KuaterCraft#0062 just because if he needs to help for Shop Bots)
    if(message.author.id != message.guild.ownerId){
      if(message.author.id != "844535327892701205")
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(0x2b2d31)
        .setAuthor('Anti Nuke Setup', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/4TeeFAdnuD')
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "<:fyes:1064768675338530857> **The Current Anti-Nuke Settings**", embeds: [new MessageEmbed()
              .setColor(0x2b2d31)
            ...
            let MenuEmbed = new Discord.MessageEmbed()
            .setColor(0x2b2d31)
            .setAuthor('Anti Nuke Settings', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/4TeeFAdnuD')
            ...
            collector.on('end', collected => {
              ...
              menuoptions = [
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.enabled") ? "1064768376829919264": "833101995723194437"
                },
                {
                  value: "Set Logger",
                ...
                },
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog") ? "1064768376829919264": "833101995723194437"
                },
                {
              ...
              async function menuselection3(menu) {
                ...
                if(String(index) == "0"){
                  ...
                  return menu?.reply({embeds: [new MessageEmbed()
                  .setFooter(client.getFooter(es)).setColor(0x2b2d31).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
                   ...
                   */
                    ...
                    async function first_layer(){
                      ...
                      let MenuEmbed = new Discord.MessageEmbed()
                        .setColor(0x2b2d31)
                        .setAuthor('Antinuke Setup', 'https://media.discordapp.net/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/4TeeFAdnuD')
                      ...
                      client.on('interactionCreate',  (menu) => {
                        if (menu?.message.id === menumsg.id) {
                          if (menu?.user.id === cmduser.id) {
                            if(used33) return menu?.reply({content: `<:fcross:1064768376829919264> You already selected something, this Selection is now disabled!`, ephemeral: true})
            ...
            return menu?.reply({content: "<:fyes:1064768675338530857> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(0x2b2d31)
              .setFooter(client.getFooter(es))
            ...
            for(const ch of channels.map(this_Code_is_by_KuaterCraft_0062 => this_Code_is_by_KuaterCraft_0062)){
              try {
                if(ch) {
