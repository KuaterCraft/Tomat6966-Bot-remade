...
///////////////////////////////////////
      ...
      if(!message.guild.me.permissions.has(Discord.Permissions.FLAGS.ADMINISTRATOR)){
        return message.reply("<:fcross:1064768376829919264> **I am missing the ADMINISTRATOR Permission!**")
      }
      ...
      if(owner.id != cmduser.id) {
          return message.reply(`<:fcross:1064768376829919264> **You need to be the Owner of this Server!**`)
      }
        ...
        let menuoptions = [
          {
            ...
            emoji: !client.settings.get(message.guild.id, "autobackup") ? "833101995723194437" : "1064768376829919264"
          },
          {
            value: "Cancel",
