...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    let theemoji = "📜";
    let FerrenGuild = client.guilds.cache.get("773668217163218944");
    if (FerrenGuild) theemoji = "877653386747605032";
    ...
    async function first_layer() {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(0x2b2d31)
          .setAuthor('Application Setup', 'https://cdn.discordapp.com/emojis/877653386747605032.png?size=96', 'https://discord.gg/4TeeFAdnuD')
        ...
        collector.on('collect', menu => {
          ...
          else menu?.reply({content: `<:fcross:1064768376829919264> You are not allowed to do that! Only: <@${cmduser.id}>`, ephemeral: true});
        });
        //Once the Collections ended edit the menu message
        collector.on('end', collected => {
          menumsg.edit({embeds: [menumsg.embeds[0].setDescription(`~~${menumsg.embeds[0].description}~~`)], components: [], content: `${collected && collected.first() && collected.first().values ? `<:fyes:1064768675338530857> **Selected: \`${collected ? collected.first().values[0] : "Nothing"}\`**` : "❌ **NOTHING SELECTED - CANCELLED**" }`})
        });
      } catch (e) {
    ...
    async function second_layer(SetupNumber, menuoptiondata) {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(0x2b2d31)
          .setAuthor(SetupNumber + " Apply Setup", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png", "https://discord.gg/4TeeFAdnuD")
    ...
    async function handle_the_picks(optionhandletype) {
      ...
      try {
        ...
        switch (args) {
          case "create": {
            ...
            async function setup_with_channel_creation() {
              ...
              var f_applychannel;
              message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31)
                                ...
                                msg.channel.awaitMessages({
                                  ...
                                  if (collected.first().content.toLowerCase() === "no") {
                                    ...
                                    if (!message.guild.me.roles) return message.reply({
                                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable25"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                        dynamic: true
                                      }))]
                                    })
            ...
            async function setup_without_channel_creation() {
              ...
              await pickmsg.channel.awaitMessages({filter: (m) => m.author.id === cmduser.id,
                  ...
                  if (channel) {
                    ...
                    throw "<:fcross:1064768376829919264> ERROR";
                  }
                })
                .catch(e => {
                  errored = e
                    ...
                    message.reply({
                      ...
                      msg.channel.awaitMessages({
                        ...
                        if (collected.first().content.toLowerCase() === "no") {
                          ...
                          if (!message.guild.me.roles) return message.reply({
                            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable58"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                              dynamic: true
                            }))]
                          })
        ...
        case "acceptmsg": {
          message.reply({
            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept message?", message.author.displayAvatarURL({
              dynamic: true
            }))]
          }).then(msg => {
            msg.channel.awaitMessages({
        ...
        case "acceptrole": {
          message.reply({
            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept Role, which will be granted when the User got accepted?", message.author.displayAvatarURL({
              dynamic: true
            }))]
          }).then(msg => {
            msg.channel.awaitMessages({
              ...
              if (!message.guild.me.roles) return message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable70"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              })
              ...
              if (guildrole.rawPosition <= botrole.rawPosition) {
                ...
                return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable71"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
              }
        ...
        case "denymsg": {
          message.reply({
            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new deny message?", message.author.displayAvatarURL({
              dynamic: true
            }))]
          }).then(msg => {
            msg.channel.awaitMessages({
        ...
        case "ticketmsg": {
          message.reply({
            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new Ticket message? | {user} pings the User", message.author.displayAvatarURL({
              dynamic: true
            }))]
          }).then(msg => {
            msg.channel.awaitMessages({
        ...
        case "emojione": {
          ...
          switch (type) {
            case "message": {
              message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept message for emoji one?", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              }).then(msg => {
                msg.channel.awaitMessages({
          ...
          case "setrole": {
            message.reply({
              embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji one?", message.author.displayAvatarURL({
                dynamic: true
              }))]
            }).then(msg => {
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable81"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable82"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
        ...
        case "emojitwo": {
          ...
          switch (type) {
            case "message": {
              message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept message for emoji two?", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              }).then(msg => {
                msg.channel.awaitMessages({
          ...
          case "setrole": {
            message.reply({
              embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji two?", message.author.displayAvatarURL({
                dynamic: true
              }))]
            }).then(msg => {
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable100"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable101"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
        ...
        case "emojithree": {
          ...
          switch (type) {
            case "message": {
              message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept message for emoji three?", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              }).then(msg => {
                msg.channel.awaitMessages({
          ...
          case "setrole": {
            message.reply({
              embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji three?", message.author.displayAvatarURL({
                dynamic: true
              }))]
            }).then(msg => {
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable119"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable120"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
        ...
        case "emojifour": {
          ...
          switch (type) {
            case "message": {
              message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept message for emoji four?", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              }).then(msg => {
                msg.channel.awaitMessages({
          ...
          case "setrole": {
            message.reply({
              embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji four?", message.author.displayAvatarURL({
                dynamic: true
              }))]
            }).then(msg => {
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable140"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable141"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
        ...
        case "emojifive": {
          ...
          switch (type) {
            case "message": {
              message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept message for emoji five?", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              }).then(msg => {
                msg.channel.awaitMessages({
          ...
          case "setrole": {
            message.reply({
              embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new accept Role, which will be granted when the User got accepted for emoji five?", message.author.displayAvatarURL({
                dynamic: true
              }))]
            }).then(msg => {
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable161"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable162"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    }))]
                  })
                }
        ...
        case "editquestion": {
          ...
          var embed = new Discord.MessageEmbed()
            ...
            .setColor(0x2b2d31)
            .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable174"])) //KuaterCraft#0062
          ...
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              if (arr.length >= Number(quindex)) {
                message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor(0x2b2d31).setAuthor("What should be the new Question?", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                }).then(msg => {
                  msg.channel.awaitMessages({
                    ...
                    var new_embed = new Discord.MessageEmbed().setFooter(client.getFooter(es))
                      .setColor(0x2b2d31)
                      .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable177"])) //KuaterCraft#0062
        ...
        case "temprole":
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              if (!message.guild.me.roles) return message.reply({
                embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable183"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                  dynamic: true
                }))]
              })
              ...
              if (guildrole.rawPosition <= botrole.rawPosition) {
                ...
                return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable184"])).setAuthor("<:fcross:1064768376829919264> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  }))]
                })
              }
        ...
        case "addquestion": {
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              var embed = new Discord.MessageEmbed().setFooter(client.getFooter(es))
                .setColor(0x2b2d31)
                .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable188"])) //KuaterCraft#0062
                .setFooter(message.guild.name, message.guild.iconURL({
                  dynamic: true
                }))
                .setTimestamp()
        ...
        case "removequestion": {
          ...
          var embed = new Discord.MessageEmbed()
            ...
            .setColor(0x2b2d31)
            .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable190"])) //KuaterCraft#0062
            .setFooter("ADD THE INDEX TO EDIT THE MSG", message.guild.iconURL({
              dynamic: true
            }))
            .setTimestamp()
          ...
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              if (arr.length >= Number(quindex)) {
                ...
                var new_embed = new Discord.MessageEmbed().setFooter(client.getFooter(es))
                  .setColor(0x2b2d31)
                  .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable193"])) //KuaterCraft#0062
                  .setFooter(message.guild.name, message.guild.iconURL({
                    dynamic: true
                  }))
                  .setTimestamp()
        ...
        case "last_verify": {
          ...
          var embed = new Discord.MessageEmbed()
            .setFooter(client.getFooter(es))
            .setColor(0x2b2d31)
            .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable219"])) //KuaterCraft#0062
            .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable220"])) //KuaterCraft#0062
            .setTimestamp()
          message.reply({
            embeds: [embed]
          });
...
/**
 * @INFO
 * Bot Coded by KuaterCraft#0062 | https://github?.com/KuaterCraft#0062/Discord-Js-Handler-Template
 * @INFO
*/
