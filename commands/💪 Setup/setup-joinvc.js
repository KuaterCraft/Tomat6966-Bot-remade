    ...
    try {//ensure the database
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(0x2b2d31)
          .setAuthor('Join VC System', 'https://cdn.discordapp.com/emojis/834052497492410388.gif?size=96', 'https://discord.gg/4TeeFAdnuD')
                      ...
                      try {
                        ...
                        if(a.map(d => d.channelId).includes(Voicechannel.id))
                          return message.reply({embeds: [new Discord.MessageEmbed()
                            .setTitle(`<:fcross:1064768376829919264> This Channel is already Setupped!`)
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<:fyes:1064768675338530857> I will now send Messages after someone joins the VC \`${Voicechannel.name}\` in the TextChannel **${Textchannel.name}**`)
                          .setColor(0x2b2d31)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      try {
                        ...
                        if(!a.map(d => d.channelId).includes(Voicechannel.id))
                          return message.reply({embeds: [new Discord.MessageEmbed()
                            .setTitle(`<:fcross:1064768376829919264> This Channel has not been Setup yet!`)
                            .setColor(0x2b2d31)
                            .setFooter(client.getFooter(es))
                          ]});
                        client.joinvc.remove(message.guild.id, d => d.channelId == Voicechannel.id, "vcmessages")
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<:fyes:1064768675338530857> Successfully removed **${Voicechannel.name}** out of the Setup!`)
                          .setColor(0x2b2d31)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<:fyes:1064768675338530857> I will now Add the Role \`${Role.name}\` when someone joins the VC **${Discord.VoiceChannel.name}**`)
                          .setColor(0x2b2d31)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
