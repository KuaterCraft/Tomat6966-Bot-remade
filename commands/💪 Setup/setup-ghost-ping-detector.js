    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(0x2b2d31)
          .setAuthor('Ghost-Ping-Detector Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/bookmark_1f516.png', 'https://discord.gg/4TeeFAdnuD')
                  ...
                  if (channel) {
                    try {
                      ...
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:fyes:1064768675338530857> I will now send all detected Ghost Pings in \`${channel.name}\``)
                        .setColor(0x2b2d31)
