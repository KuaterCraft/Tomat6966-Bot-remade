    ...
    try {
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(0x2b2d31)
          .setAuthor('Twitter Setup', 'https://cdn.discordapp.com/emojis/840255600851812393.png?size=96', 'https://discord.gg/4TeeFAdnuD')
          ...
          await tempmsg.channel.awaitMessages({
            ...
            .then(async collected => {
              try {
                ...
                message.reply({
                  embeds: [new Discord.MessageEmbed()
                    .setTitle(`<:fyes:1064768675338530857> Set the TWITTER USER ID TO: \`${collected.first().content}\``.substr(0, 256))
                ...
                await tempmsg.channel.awaitMessages({
                  ...
                  .then(async collected => {
                    try {
                      ...
                      return message.reply({
                        embeds: [new Discord.MessageEmbed()
                          .setTitle(`<:fyes:1064768675338530857> Set the TWITTER USER Name TO: \`${collected.first().content}\``.substr(0, 256))
...
/**
 * @INFO
 * Bot Coded by KuaterCraft#0062 | https://github?.com/FerrenDev/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
*/