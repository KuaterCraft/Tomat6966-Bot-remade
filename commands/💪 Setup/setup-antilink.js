        ...
        let menuoptions = [
          {
            ...
            emoji: `${client.settings.get(message.guild.id, `antilink.enabled`) ? "1064768376829919264" : "833101995723194437"}`
          },
          {
            value: "Settings",
