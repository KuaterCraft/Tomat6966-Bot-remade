    ...
    try {
      ...
      let menuoptions = [
        ...
        },
        {
          ...
          emoji: "1064768376829919264" //optional
        },
        {
          value: "Remove Fakes",
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          .setColor(0x2b2d31)
          .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/4TeeFAdnuD")
          ...
          message.reply({embeds : [new MessageEmbed()
            .setAuthor(`New Invites of: ${user.tag}`, user.displayAvatarURL({dynamic: true}), "https://discord.gg/4TeeFAdnuD")
