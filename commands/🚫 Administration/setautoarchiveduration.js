    ...
    try {
      ...
      if(!channel.isThread())
        return message.reply({embeds :[new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(client.getFooter(es))
          .setTitle(`<:fcross:1064768376829919264> **This Channel is not a Thread**`)
        ]});
      if(!args[0])
        return message.reply({embeds :[new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(client.getFooter(es))
          .setTitle(`<:fcross:1064768376829919264> **You forgot to add a Cooldown amount**`)
      ...
      message.reply({embeds :[new MessageEmbed()
        .setColor(0x2b2d31)
        .setFooter(client.getFooter(es))
        .setTitle(`<:fyes:1064768675338530857> **Successfully changed the autoarchive Duration to \`${duration}\` of ${channel.name}**`)
      ]});
