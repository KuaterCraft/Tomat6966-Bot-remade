...
module.exports = {
    ...
    const { guild } = member;    
    try{
      let tempmsg = await interaction?.reply({embeds: [new Discord.MessageEmbed().setColor(0x2b2d31)
      .setAuthor(client.la[ls].cmds.info.botinfo.loading, "https://cdn.discordapp.com/emojis/756773010123522058.gif", "https://discord.gg/4TeeFAdnuD")], ephemeral: true})
      cpuStat.usagePercent(function (e, percent, seconds) {
        ...
        const botinfo = new Discord.MessageEmbed()
            ...
            .addField(client.la[ls].cmds.info.botinfo.field2.title, `\`\`\`\nNode.js: ${process.version}\nDiscord.js: v${Discord.version}\nEnmap: v5.8.4\`\`\``, true)
            ...
            .addField(client.la[ls].cmds.info.botinfo.field4.title, `\`\`\`\nName: KuaterCraft#0062\nID: [844535327892701205]\`\`\``, true)
